...
public class FakeSCM
{
    public static ScmProvider getSCMProvider( String comment, String... tags )
    {
        return new AbstractScmProvider()
        {
            @Override
    ...
    public static ScmRepository getScmRepository() {
        try {
            return new ScmRepository( "dummy", getSCMProvider("dummy").makeProviderScmRepository("dummy", ':') );
