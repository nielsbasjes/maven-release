...
public class VersionPolicyRequest
{
     ...
     *
     * @return the {@link String} that contains the basedir (can be null or empty).
     */
     ...
     *
     * @param basedir The {@link String} that contains the basedir (can be null or empty).
     * @return a {@link org.apache.maven.shared.release.policy.version.VersionPolicyRequest} object
     */
    public VersionPolicyRequest setBasedir( String basedir )
    {
